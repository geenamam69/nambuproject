...
import { Button, Stack, TextField, Grid2 as Grid } from "@mui/material";
...
const Word = () => {
  ...
  return (
    ...
    >
      <Grid size={8}>
        {/* <TextField
          ...
          onChange={(e) => {
            ...
            setInput_type(1);
            const data = await handlelikefetchWord(word);
          }}
        /> */}
        <Asynchronous />
      </Grid>
      ...
      <Grid size={6}>
        <Category key={c_id} cid={c_id} onSelect={setC_id} />
      </Grid>
      <Grid size={6}></Grid>
      <Grid size={12}>
        <TextField
      ...
      <Grid item>
        <Stack spacing={2} direction="row">
          ...
          <Button type="submit" variant="outlined" sx={{ width: "150px" }}>
            수정
          </Button>
          <Button
            onClick={(e) => {
